      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mb-8">
            <img src="/3.png" alt="Partner Logo" className="h-12 opacity-90 hover:opacity-100 transition-opacity object-contain" />
            <img src="/logo 3 copy.png" alt="Partner Logo" className="h-12 opacity-90 hover:opacity-100 transition-opacity object-contain" />
          </div>
